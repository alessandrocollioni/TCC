...
def geraImagem(mapa, position, goal):
    ...
    #ptGoal = (5,5)
    #ptRobot = (1,1)
    (came_from, cost_so_far) = a_star.dijkstra_search(grafo, ptRobot, ptGoal)
...
#print 'NUMEROS DE ESTADOS EXPANDIDOS Dijkstra:', a_star.funcCountOpenList() 
#print 'NUMEROS DE ESTADOS EXPANDIDOS A-Star:', a_star.funcCountOpenList() 
#QUANTIDADE DE PASSOS PARA ATINGIR O OBJETIVO(-5,-5) - 3195 | 3195
#QUANTIDADE DE PASSOS PARA ATINGIR O OBJETIVO(-6,-6) - 4294 | 4294
#VIZINHOS VISITADOS(-6, -6) - 4544 | 4544
#VIZINHOS VISITADOS(-5, -5) - 3425 | 3425
